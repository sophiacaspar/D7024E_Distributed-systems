...
/* Command to run a test-case: "go test -test.run TestDHTX" where X i testnumber 1-3  */

import (
	"fmt"
	"testing"
)
/* Starts all nodes and prints the ring */
...
/* Lookup the node responsible for a hashed key */
