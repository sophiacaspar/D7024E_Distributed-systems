...
func createUpdateFileMsg(t, origin, dst, filename, data string) *Msg{
 	Msg := &Msg{}
 	Msg.Type = "updateFile"
 	Msg.Origin = origin
 	Msg.Key = ""
  ...
  func createGetFilesMsg(origin, src, dst string) *Msg{
 	Msg := &Msg{}
 	Msg.Type = "getFiles"
 	Msg.Origin = origin
 	Msg.Key = ""
   ...
   func createFileResponseMsg(src, dst, filename, data string) *Msg{
 	Msg := &Msg{}
 	Msg.Type = "fileResponse"
 	Msg.Origin = ""
 	Msg.Key = ""
 	Msg.Src = src
 	Msg.Dst = dst
